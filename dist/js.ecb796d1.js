...
},{}],"../node_modules/@firebase/auth/dist/esm2017/index-90ebcfae.js":[function(require,module,exports) {
"use strict";
...
Object.defineProperty(exports, "updateEmail", {
  enumerable: true,
  get: function () {
    return _index90ebcfae.ag;
  }
});
Object.defineProperty(exports, "updatePassword", {
  enumerable: true,
  get: function () {
    return _index90ebcfae.ah;
  }
});
...
Object.defineProperty(exports, "verifyBeforeUpdateEmail", {
  enumerable: true,
  get: function () {
    return _index90ebcfae.ac;
  }
});
Object.defineProperty(exports, "verifyPasswordResetCode", {
  enumerable: true,
  get: function () {
    return _index90ebcfae.a4;
  }
});

var _index90ebcfae = require("./index-90ebcfae.js");
...
},{"./index-90ebcfae.js":"../node_modules/@firebase/auth/dist/esm2017/index-90ebcfae.js","@firebase/util":"../node_modules/@firebase/util/dist/index.esm2017.js","@firebase/app":"../node_modules/@firebase/app/dist/esm/index.esm2017.js","tslib":"../node_modules/tslib/tslib.es6.js","@firebase/logger":"../node_modules/@firebase/logger/dist/esm/index.esm2017.js","@firebase/component":"../node_modules/@firebase/component/dist/esm/index.esm2017.js"}],"../node_modules/firebase/auth/dist/index.esm.js":[function(require,module,exports) {
"use strict";
...
},{"@firebase/auth":"../node_modules/@firebase/auth/dist/esm2017/index.js"}],"../firebase/config.js":[function(require,module,exports) {
"use strict";
...
var auth = (0, _auth.getAuth)(firebaseApp); // const db = getFirestore(firebaseApp)

exports.auth = auth;
},{"firebase/app":"../node_modules/firebase/app/dist/index.esm.js","firebase/auth":"../node_modules/firebase/auth/dist/index.esm.js"}],"static/js/views/AbstractView.js":[function(require,module,exports) {
"use strict";
...
var _default = /*#__PURE__*/function () {
  ...
  _createClass(_default, [{
    ...
    key: "renderHTML",
    value: function () {
      var _renderHTML = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    value: function () {
      var _beforeInitialRender = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    value: function mutationObserver(callback) {
...
},{}],"static/images/logo.png":[function(require,module,exports) {
module.exports = "/logo.ab45e29d.png";
},{}],"static/images/background-dark.png":[function(require,module,exports) {
module.exports = "/background-dark.1b7a5c83.png";
},{}],"static/images/background-light.png":[function(require,module,exports) {
module.exports = "/background-light.0e16d54d.png";
},{}],"static/js/views/Nav.js":[function(require,module,exports) {
"use strict";
...
var _backgroundDark = _interopRequireDefault(require("../../images/background-dark.png"));

var _backgroundLight = _interopRequireDefault(require("../../images/background-light.png"));

var _authentication = require("../../../../firebase/authentication.js");
...
var _default = /*#__PURE__*/function (_AbstractView) {
  ...
  function _default() {
    ...
    _this.clickedTheme = false;
    _this.userLogin = (0, _authentication.getUserLogin)();
    _this.isAuth = (0, _index.getIsAuth)();
    return _this;
  }
  ...
  _createClass(_default, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                headerElement.innerHTML = "<img target-url=\"/\" class=\"logo\" src=\"".concat(_logo.default, "\" alt=\"logo\">");
    ...
    key: "initialEvent",
    value: function () {
      var _initialEvent = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(userLogin) {
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return this.renderHTML(userLogin);
      ...
      function initialEvent(_x) {
        return _initialEvent.apply(this, arguments);
      }
    ...
    value: function theme() {
      ...
      var circle = document.querySelector(".circle-in-circle");

      if (this.clickedTheme) {
        document.querySelector(".circle").classList.add("clicked-circle");
        body.classList.add("body-theme");
        body.style.backgroundImage = "url(\"".concat(_backgroundDark.default, "\")");
        ...
        body.style.backgroundImage = "url(\"".concat(_backgroundLight.default, "\")");
...
exports.default = _default;
},{"./AbstractView.js":"static/js/views/AbstractView.js","../../images/logo.png":"static/images/logo.png","../../images/background-dark.png":"static/images/background-dark.png","../../images/background-light.png":"static/images/background-light.png","../../../../firebase/authentication.js":"../firebase/authentication.js","../store/index.js":"static/js/store/index.js"}],"static/js/store/index.js":[function(require,module,exports) {
"use strict";
...
var _Nav = _interopRequireDefault(require("../views/Nav.js"));
...
var is_auth = false;
var fixedUrl = "https://murmuring-peak-30038.herokuapp.com";
exports.fixedUrl = fixedUrl;

function initialization(_x, _x2) {
  return _initialization.apply(this, arguments);
}

function _initialization() {
  _initialization = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(userLogin, uid) {
    var nav;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            if (!initialized) {
              (0, _index.routingEvent)();
              nav = new _Nav.default();
...
function fetchScoreData(_x3) {
  return _fetchScoreData.apply(this, arguments);
}

function _fetchScoreData() {
  _fetchScoreData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(uid) {
    var url, scorePath, scoreEndpoint;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            url = fixedUrl;
            scorePath = "/api/score-id/:id=".concat(uid);
            scoreEndpoint = url + scorePath;
            _context2.next = 5;
            return fetch(scoreEndpoint, {}).then(function (result) {
              return result.json();
            }).then(function (data) {
...
function getUserData(_x4) {
  return _getUserData.apply(this, arguments);
}

function _getUserData() {
  _getUserData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(uid) {
    var url, userPath, userEndpoint;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            url = fixedUrl;
            userPath = "/api/user-id/:id=".concat(uid);
            userEndpoint = url + userPath;
            _context3.next = 5;
            return fetch(userEndpoint, {}).then(function (result) {
              return result.json();
            }).then(function (data) {
...
},{"../index.js":"static/js/index.js","../views/Nav.js":"static/js/views/Nav.js"}],"../firebase/authentication.js":[function(require,module,exports) {
"use strict";
...
var _store = _interopRequireWildcard(require("../frontend/static/js/store"));
...
function _createUser() {
  _createUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(user) {
          ...
          case 0:
            return _context4.abrupt("return", new Promise( /*#__PURE__*/function () {
              var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(resolve, reject) {
                var username, email, password, score;
                return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      case 0:
                        username = user.username, email = user.email, password = user.password, score = user.score;
                        _context3.next = 3;
                        return (0, _auth.createUserWithEmailAndPassword)(_config.auth, email, password).then( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
                          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                            while (1) {
                              switch (_context2.prev = _context2.next) {
                                case 0:
                                  _context2.next = 2;
                                  return (0, _auth.updateProfile)(_config.auth.currentUser, {
                                    displayName: username
                                  }, resolve()).catch(function (error) {
                                    var FBError = {
...
function login(user) {
  return new Promise(function (resolve, reject) {
    ...
    (0, _auth.signInWithEmailAndPassword)(_config.auth, email, password).then(function () {
      // Signed in
      resolve();
    }).catch(function (error) {
      var FBError = {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 2:
            (0, _store.removeSessionItem)("currentScore");
...
function authChange() {
  (0, _auth.onAuthStateChanged)(_config.auth, /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              if (user) {
                (0, _store.default)(userLogin, user.uid);
              } else {
                (0, _store.default)(userLogin);
              }
...
authChange();
},{"./config":"../firebase/config.js","firebase/auth":"../node_modules/firebase/auth/dist/index.esm.js","../frontend/static/js/store":"static/js/store/index.js"}],"static/js/views/PopupNotification.js":[function(require,module,exports) {
"use strict";
...
var _default = /*#__PURE__*/function (_AbstractView) {
  ...
  function _default(messageArray, notificationTitle, node, type) {
    var _this;
    ...
    _this.type = type; //error for error, green for success

    _this.notificationTitle = notificationTitle;
    _this.mainNode = node;
    return _this;
  }
  ...
  _createClass(_default, [{
    key: "initialEvent",
    value: function () {
      var _initialEvent = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var _this2 = this;

        var Title, noteSection, promise;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                Title = "<div class=\"".concat(this.type, "-title\">").concat(this.notificationTitle, "</div>");
                noteSection = document.createElement("div");
                noteSection.className = "".concat(this.type, "-section");
                noteSection.innerHTML += Title;
                this.messageArray.forEach(function (err) {
                  noteSection.innerHTML += "<li class=\"each-".concat(_this2.type, "\">").concat(err, "</li>");
                });
                this.mainNode.append(noteSection);
                promise = new Promise(function (resolve, reject) {
                  setTimeout(function () {
                    _this2.mainNode.removeChild(noteSection);
...
exports.default = _default;
},{"./AbstractView.js":"static/js/views/AbstractView.js"}],"static/js/views/dashboard/AllQuestions.js":[function(require,module,exports) {
"use strict";
...
var _PopupNotification = _interopRequireDefault(require("../PopupNotification.js"));
...
var _default = /*#__PURE__*/function (_AbstractView) {
  ...
  function _default() {
    ...
    _defineProperty(_assertThisInitialized(_this), "checkCurrentItem", function () {
      var counter = 0;
      Object.values(_this.currentData).forEach(function (elem) {
        if (Array.isArray(elem)) {
          if (elem.length) {
            _this.currentDataExist = true;
            counter += 1;
          }
        } else {
          if (elem) {
      ...
      if (counter == 0) {
        _this.currentDataExist = false;
        _this.num.innerHTML = "";
      } else {
        if (!_this.currentDom.length) {
          _this.num.innerHTML = "<div aria-live=\"polite\" class=\"no-num\">no terms found</div>";
        }
      }
    ...
    _this.options;
    _this.mainNode;
    _this.tagsArray = ["General", "Git", "GitHub", "Internet", "Node", "Protocol", "HTTP", "Front-End", "Programming", "JavaScript", "Browser", "DOM", "Higher-Order Functions", "Events", "Functional"];
    _this.chosenTags = [];
    _this.selecterWindowContainer;
    _this.selectChosen;
    _this.editButton;
    _this.formError = [];
    _this.patchElement;
  ...
  _createClass(_default, [{
    ...
    key: "initialEvent",
    value: function () {
      var _initialEvent = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var _this2 = this;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 5;
                return this.fetchQuizData().then(function () {
                  _this2.getClassOption();

                  _this2.tags = _this2.getSelectOption();
                  _this2.keysArray = Object.keys(_this2.apiData[0]);
                  delete _this2.keysArray[0]; //delete UUID

                  _this2.container = document.querySelector(".result-container");
                  _this2.num = document.querySelector(".num-items-container");
                  _this2.text = document.querySelector(".text-input");

                  _this2.text.addEventListener("change", function (e) {
                    return _this2.firstSearch(e);
                  });

                  _this2.options = document.querySelector("select");

                  _this2.options.addEventListener("change", function (e) {
                    return _this2.firstSearch(e);
                  });

                  _this2.allChecks = document.querySelectorAll(".check");

                  for (var i = 0; i < _this2.allChecks.length; i++) {
                    _this2.allChecks[i].addEventListener("change", function (e) {
                      return _this2.firstSearch(e);
                    });
                  }
                });
    ...
    value: function () {
      ...
      function fetchQuizData() {
        return _fetchQuizData.apply(this, arguments);
      }
    ...
    value: function getSelectOption() {
      ...
      for (var i = 0; i <= this.apiData.length - 1; i++) {
        var tagsArray = this.tagsStringToArray(this.apiData[i]);
        tagsArray.forEach(function (elem) {
          set.add(elem);
        });
      }

      var ckeckBoxContainer = document.querySelector(".checkbox-container");
      set.forEach(function (elem) {
        ckeckBoxContainer.innerHTML += "<div class='each-tag'>\n            <input class=\"check\" name=\"check\" id=".concat(elem, " type=\"checkbox\">\n            <label for=").concat(elem, ">").concat(elem, "</label>\n            </div>");
      });
      return Array.from(set);
    }
  }, {
    key: "getClassOption",
    value: function getClassOption() {
      var set = new Set();
      ...
      set.forEach(function (elem) {
        select.innerHTML += "<option class=\"option\" id=".concat(elem, " value=").concat(elem, ">").concat(elem, "</option>");
      });
    }
  }, {
    key: "firstSearch",
    value: function firstSearch(e) {
      var _this4 = this;
      ...
      var textSearch = function textSearch(value) {
        ...
        var _loop = function _loop(i) {
          Object.values(gs[i]).forEach(function (elem) {
            if (Array.isArray(elem)) {
        ...
        _this4.currentData.text = value;
        return Array.from(set);
      };

      var classSearch = function classSearch(value) {
        var array = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
        ...
        if (value) {
          ...
          _this4.currentData.class = value;
          return Array.from(set);
        } else {
          _this4.checkCurrentItem();
      ...
      var tagSearch = function tagSearch() {
        var _loop2 = function _loop2(i) {
          Object.keys(gs[i]).forEach(function (elem) {
            if (elem === "tags") {
              var tagArray = _this4.tagsStringToArray(gs[i]);

              tagArray.forEach(function (e) {
                _this4.currentData.tags.forEach(function (t) {
                  if (e.indexOf(t) !== -1) {
                    set.add(gs[i]);
                  }
                });
      ...
      var centerSearch = function centerSearch(event) {
        var baseArrayForSearch = [];
        var textEmpty = false; //for bag solution

        if (event.target.type == "text") {
          _this4.currentData.text = event.target.value;
        } else if (event.target.type == "select-one") {
          _this4.currentData.class = event.target.value;
        } else if (event.target.type == "checkbox") {
          if (event.target.checked) {
            _this4.currentData.tags.push(event.target.id);
          } else {
            _this4.currentData.tags.forEach(function (e) {
              if (e == event.target.id) {
                _this4.currentData.tags = _this4.currentData.tags.filter(function (t) {
                  return t != e;
                });
              }
            });
        ...
        if (_this4.currentData.tags.length) {
          baseArrayForSearch = tagSearch();
        } else if (_this4.currentData.class) {
          baseArrayForSearch = classSearch(_this4.currentData.class);
        }

        if (_this4.currentData.tags.length) {
          Object.keys(_this4.currentData).forEach(function (key) {
            set = new Set();

            if (key == "class") {
              if (_this4.currentData.class) {
                baseArrayForSearch = classSearch(_this4.currentData.class, baseArrayForSearch);
              }
            } else if (key == "text") {
              if (_this4.currentData.text) {
                baseArrayForSearch = textSearch(_this4.currentData.text, baseArrayForSearch); // bag occur here
          ...
          if (!baseArrayForSearch.length) {
            baseArrayForSearch = _this4.apiData;
          }

          set = new Set();
          baseArrayForSearch = textSearch(_this4.currentData.text, baseArrayForSearch);
        }
      ...
      if (e.target.type == "checkbox") {
        var index = this.currentData.tags.indexOf(e.target.id);
    ...
    value: function result(results) {
      ...
      if (results.length) {
        ...
        var patchButton = "<button class=\"edit-question\">EDIT</button>";
        results.forEach(function (result, index) {
          _this5.currentDom.push(result);

          _this5.container.innerHTML += "\n          <div aria-live=\"polite\" class=\"each-item\">\n            <div id=".concat(result.UUID, " class=\"delete-question-container\">\n              <i class=\"fas fa-times delete-question\"></i>\n            </div>\n          </div>");
          var each = document.querySelectorAll(".each-item");

          _this5.keysArray.forEach(function (e) {
            if (e !== "tags") {
              each[each.length - 1].innerHTML += "\n                <div class=\"category\">\n                  <p class=\"title\">".concat(e, ":</p>\n                  <p class=\"value\">").concat(result[e], "</p>\n                </div>");
            } else {
              each[each.length - 1].innerHTML += "<div class=\"category\">\n                              <p class=\"title\">".concat(e, ":</p>\n                              <div class=\"tags\"></div>\n                            </div>");
              _this5.tags = document.querySelectorAll(".tags");

              var tagsArray = _this5.tagsStringToArray(result);

              tagsArray.forEach(function (t) {
                _this5.tags[_this5.tags.length - 1].innerHTML += "<tag>".concat(t, "</tag>");
              });
            }
          });

          each[index].innerHTML += patchButton;
          var patchDoms = document.querySelectorAll(".edit-question");

          for (var i = 0; i < patchDoms.length; i++) {
            patchDoms[i].addEventListener("click", function (e) {
              return _this5.patchHandler(e);
            });
          }
        });
      } else {
    ...
    value: function remove(target) {
      ...
      var allItems = document.querySelectorAll(".eachItem");

      var allRemove = function allRemove() {
        _this6.container.innerHTML = "";
        _this6.currentDom = [];
        _this6.num.innerHTML = "";
        ...
        if (target.type == "text") {
          ...
          if (!target.value) {
            ...
            for (var _i = 0; _i < allItems.length; _i++) {
              if (allItems[_i].children[1].textContent == this.currentData.class) {
                allItems[_i].remove();

                this.currentDom.splice(_i);
              }
            }
          }
          ...
          for (var _i2 = 0; _i2 < allItems.length; _i2++) {
            if (allItems[_i2].children[3].innerHTML.includes(target.id)) {
              allItems[_i2].remove();

              this.currentDom.splice(_i2);
            }
          }
        }
    ...
    key: "tagsStringToArray",
    value: function tagsStringToArray(stringTag) {
      return stringTag.tags.split(",");
    }
  }, {
    key: "setResultNum",
    value: function setResultNum(length) {
      return "\n      <div aria-live=\"polite\" class=\"num\">".concat(length, " terms found</div>");
    } // @Patch Start

  }, {
    key: "patchHandler",
    value: function patchHandler(e) {
      var _this7 = this;

      this.disableScroll();
      this.id = e.target.offsetParent.firstElementChild.id; //from delete

      var question = this.apiData.find(function (data) {
        return data.UUID === _this7.id;
      });
    ...
    key: "_selectorEvent",
    value: function _selectorEvent() {
      var _this8 = this;

      this.selecterWindowContainer = document.querySelector(".selecter-window-container");
      var selecterBox = document.querySelector(".selecter-box");
      var selecterWindow = document.createElement("div");
      selecterWindow.className = "select-window";
      selecterBox.addEventListener("click", function () {
        if (!_this8.windowIsOpen) {
          for (var i = 0; i < _this8.tagsArray.length; i++) {
            var tagChild = document.createElement("div");
            tagChild.className = "each-tag-in-window";
            tagChild.innerHTML = "".concat(_this8.tagsArray[i]);
            selecterWindow.appendChild(tagChild);
            tagChild.addEventListener("click", chosenEvent);

            _this8.selecterWindowContainer.append(selecterWindow);

            _this8.windowIsOpen = true;
          }
        } else {
          _this8.selecterWindowContainer.innerHTML = "";
          _this8.windowIsOpen = false;
        }
      });

      var chosenEvent = function chosenEvent(e) {
        var chosenTag = e.target.innerHTML;

        if (_this8.chosenTags.includes(chosenTag)) {
          //delete
          _this8.chosenTags = _this8.chosenTags.filter(function (tag) {
            // tag.match(`/${chosenTag}/`) === null
            return tag !== chosenTag;
          });

          for (var i = 0; i < _this8.selectChosen.children.length; i++) {
            if (_this8.selectChosen.children[i].innerHTML === chosenTag) {
              var child = document.querySelector(".".concat(chosenTag));

              _this8.selectChosen.removeChild(child);
            }
          ...
          _this8.chosenTags.push(chosenTag);

          _this8.selectChosen.innerHTML += "<div class=\"chosen-tag ".concat(chosenTag, "\">").concat(chosenTag, "</div>");
          _this8.windowIsOpen = false;
          _this8.selecterWindowContainer.innerHTML = "";
        }
      };
    ...
    key: "_checkForm",
    value: function _checkForm(inputValues) {
      for (var i = 0; i < inputValues.length; i++) {
        if (!inputValues[i].value) {
          this.formError.push("".concat(inputValues[i].name, " is empty."));
        }
      }
    ...
    value: function () {
            ...
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                return fetch(endpoint, {
                  ...
                  var notify = new _PopupNotification.default([], "UPLOADED", _this9.mainNode, "success");

                  _this9.closeEditModal();

                  notify.initialEvent();
                  _this9.editButton.disabled = false;

                  for (var i = 0; i < _this9.inputValues.length; i++) {
                    _this9.inputValues[i].value = "";
                  }

                  _this9.chosenTags = [];
                  _this9.selectChosen.innerHTML = "";
                }).catch(function (e) {
              ...
              case 15:
                ...
                color = "error";
                notify = new _PopupNotification.default(this.formError, title, this.mainNode, color);
                notify.initialEvent();
      ...
      function patchQuestion() {
        return _patchQuestion.apply(this, arguments);
      }
    ...
    value: function deleteQuestion() {
      ...
      var url = _index.fixedUrl;
      var path = "/api/quiz/js:id=";
      var endpoint = url + path;
      var deleteQuestionContainer = document.querySelectorAll(".delete-question-container");
              ...
              while (1) {
                switch (_context5.prev = _context5.next) {
                  case 0:
                    ...
                    removeItemFromBrowser = deleteQuestionContainer[i].parentElement;
      ...
      for (var i = 0; i < deleteQuestionContainer.length; i++) {
        _loop3(i);
      }
    }
  }, {
    ...
    value: function disableScroll() {
      ...
      var scrollLeft = window.pageXOffset; // if any scroll is attempted,
...
exports.default = _default;
},{"../../store/index.js":"static/js/store/index.js","../AbstractView.js":"static/js/views/AbstractView.js","../PopupNotification.js":"static/js/views/PopupNotification.js"}],"static/js/views/dashboard/QuizCreate.js":[function(require,module,exports) {
"use strict";
...
var _default = /*#__PURE__*/function (_AbstractView) {
  ...
  _createClass(_default, [{
    ...
    value: function _selectorEvent() {
      ...
      selecterWindow.className = "select-window";
      selecterBox.addEventListener("click", function () {
        if (!_this3.windowIsOpen) {
          selecterWindow.innerHTML = "";

          for (var i = 0; i < _this3.tagsArray.length; i++) {
            var tagChild = document.createElement("div");
            tagChild.className = "".concat(_this3.tagsArray[i], " each-tag-in-window");
            tagChild.innerHTML = "".concat(_this3.tagsArray[i]);
            selecterWindow.appendChild(tagChild);
            tagChild.addEventListener("click", chosenEvent);

            _this3.selecterWindowContainer.append(selecterWindow);

            _this3.windowIsOpen = true;
          }
        } else {
          _this3.selecterWindowContainer.innerHTML = "";
          _this3.windowIsOpen = false;
        }
      });

      var chosenEvent = function chosenEvent(e) {
        var chosenTag = e.target.classList[0];
        _this3.selectChosen = document.querySelector(".select-chosen");

        if (_this3.chosenTags.includes(chosenTag)) {
          //delete
          _this3.chosenTags = _this3.chosenTags.filter(function (tag) {
            // tag.match(`/${chosenTag}/`) === null
            return tag !== chosenTag;
          });

          for (var i = 0; i < _this3.selectChosen.children.length; i++) {
            if (_this3.selectChosen.children[i].getAttribute("name") === chosenTag) {
              var child = document.querySelector("[name = ".concat(chosenTag, "]"));

              _this3.selectChosen.removeChild(child);
            }
          ...
          _this3.chosenTags.push(chosenTag);

          _this3.selectChosen.innerHTML += "\n          <div class=\"chosen-tag ".concat(chosenTag, "\" name=\"").concat(chosenTag, "\">\n            <div class=\"tag-name\">").concat(chosenTag, "</div>\n            <div class=\"delete-tag-container\">\n              <i class=\"").concat(chosenTag, " fas fa-times delete-tag\"></i>\n            </div>\n          </div>");
          _this3.windowIsOpen = false;
          _this3.selecterWindowContainer.innerHTML = "";
          var deleteElemens = document.querySelectorAll(".delete-tag");

          for (var _i = 0; _i < deleteElemens.length; _i++) {
            deleteElemens[_i].addEventListener("click", function (e) {
              return chosenEvent(e);
            });
          }
        }
      };
    ...
    value: function _checkForm(inputValues) {
      for (var i = 0; i < inputValues.length; i++) {
        if (!inputValues[i].value) {
          this.formError.push("".concat(inputValues[i].ariaLabel, " is empty."));
        }
      }
    ...
    key: "createQuestion",
    value: function () {
      var _createQuestion = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var _this4 = this;

        var inputValues, formCheck, url, path, endpoint, term, description, classNum, tags, title, color, notify;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                inputValues = document.querySelectorAll(".text-input");
                formCheck = this._checkForm(inputValues);
                url = _index.fixedUrl;
                path = "/api/quiz/js";
                endpoint = url + path;
                ...
                return fetch(endpoint, {
                  ...
                  var notify = new _PopupNotification.default([], "CREAED", _this4.createSection, "success");
                  notify.initialEvent();
                  _this4.createButton.disabled = false;
              ...
              case 15:
                title = "ERROR OCCURRED";
                color = "error";
                notify = new _PopupNotification.default(this.formError, title, this.createSection, color);
                notify.initialEvent();
    ...
    key: "deleteEvent",
    value: function () {
      var _deleteEvent = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(id) {
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return fetch("".concat(_index.fixedUrl, "/api/").concat(id), {
                  method: "DELETE"
                });
...
exports.default = _default;
},{"../../store/index.js":"static/js/store/index.js","../AbstractView.js":"static/js/views/AbstractView.js","../PopupNotification.js":"static/js/views/PopupNotification.js"}],"static/js/views/dashboard/Dashboard.js":[function(require,module,exports) {
"use strict";
...
var _AllQuestions = _interopRequireDefault(require("./AllQuestions.js"));

var _QuizCreate = _interopRequireDefault(require("./QuizCreate.js"));
...
var _default = /*#__PURE__*/function (_AbstractView) {
  ...
  _createClass(_default, [{
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                for (i = 0; i < this.headerMenues.length; i++) {
                  this.headerMenues[i].addEventListener("click", function (e) {
                    _this2.boardControle(e);
                  });
                }
    ...
    key: "boardControle",
    value: function boardControle(e) {
      var menuItem = e.target.innerHTML;
    ...
    key: "allQuestions",
    value: function () {
      var _allQuestions = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        var instance;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
      ...
      function allQuestions() {
        return _allQuestions.apply(this, arguments);
      }
    ...
    key: "createQuestions",
    value: function () {
      var _createQuestions = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        var instance;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                instance = new _QuizCreate.default();
                _context4.next = 3;
                return instance.renderHTML();

              case 3:
                this.dashboardContainer.innerHTML = _context4.sent;
                instance.initialEvent();
    ...
    key: "handleCurrentMenu",
    value: function handleCurrentMenu(menuItem) {
      for (var i = 0; i < this.headerMenues.length; i++) {
        var eachTarget = this.headerMenues[i];
        eachTarget.classList.remove("selected-menu");
        eachTarget.style.pointerEvents = "";
      }

      var targetMenu = document.querySelector(".".concat(menuItem));
...
exports.default = _default;
},{"../AbstractView.js":"static/js/views/AbstractView.js","./AllQuestions.js":"static/js/views/dashboard/AllQuestions.js","./QuizCreate.js":"static/js/views/dashboard/QuizCreate.js"}],"static/js/views/Footer.js":[function(require,module,exports) {
"use strict";
...
var _default = /*#__PURE__*/function (_AbstractView) {
  ...
  function _default() {
    ...
    _this = _super.call(this);
    _this.gitUrl = "https://github.com/Goaty-yagi";
    _this.linkedinUrl = "https://www.linkedin.com/in/nobuhiro-funahashi-1b725322b/";
    return _this;
  }
  ...
  _createClass(_default, [{
    ...
    key: "initialEvent",
    value: function () {
      var _initialEvent = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        var _this2 = this;
...
exports.default = _default;
},{"./AbstractView.js":"static/js/views/AbstractView.js"}],"static/js/views/Ranking.js":[function(require,module,exports) {
"use strict";
...
console.log("test", _index.fixedUrl);
...
var _default = /*#__PURE__*/function (_AbstractView) {
  ...
  function _default() {
    ...
    _this = _super.call(this);
    _this.scoreData;
    _this.userData = (0, _authentication.getUserData)();
    _this.userLogin = (0, _authentication.getUserLogin)();
    _this.rankingContainer = document.createElement("div");
    _this.rankingContainer.className = "rank-section";
    _this.rankWrapper = document.createElement("div");
    _this.rankWrapper.className = "rank-wrapper";

    _this.rankingContainer.append(_this.rankWrapper); // this.setTitle(" Ranking")
  ...
  _createClass(_default, [{
    ...
    value: function () {
      var _renderHTML = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        var userStyleClass, username, currentScore, welcome;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
              ...
              case 2:
                this.scoreData = _context.sent;
                this.rankWrapper.innerHTML += "<h1>RANKING</h1>";

                if (this.userLogin) {
                  username = this.userData.name;
                  currentScore = (0, _index.getSessionItem)("currentScore");
                  welcome = "\n        <div class=\"welcome-container\">\n          <div>WELCOME ".concat(username, "!</div>\n            <div>Your Max Score is ").concat(currentScore, "</div>\n          </div>\n        </div>\n      ");
                  this.rankWrapper.innerHTML += welcome;
                }

                this.scoreData.forEach(function (elem, index) {
                  if (elem.UUID === _this2.userData.UID) {
                  ...
                  if (index + 1 === 1) {
                    awardFont = "\n          <i class=\"fas fa-crown rank-font\">\n            <div class=\"rank-order\">".concat(index + 1, "\n            </div>\n          </i>\n      ");
                  } else if (index + 1 === 2) {
                    awardFont = "\n          <i class=\"fas fa-award second-award rank-font\">\n            <div class=\"rank-order second-third\">".concat(index + 1, "\n            </div>\n          </i>\n        ");
                  } else if (index + 1 === 3) {
                  ...
                  _this2.rankWrapper.innerHTML += "\n        <section class=\"each-ranking-container\">\n          <div class=\"rank\">".concat(awardFont, "</div>\n          <div class=\"").concat(userStyleClass, "\">").concat(elem.username, "</div>\n          <div class=\"score\">").concat(elem.score, "</div>\n        </section>\n        ");
                });
                return _context.abrupt("return", this.rankingContainer);
    ...
    key: "getScoreData",
    value: function () {
      var _getScoreData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                return _context3.abrupt("return", fetch(this.endpoint).then(function (result) {
                  return result.json();
                }).then(function (data) {
                  return data;
                }));
    ...
    key: "fetchData",
    value: function () {
      var _fetchData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        var url, path, params, endpoint;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                path = "/api/score";
                params = "/type=js";
                endpoint = url + path + params;
                return _context4.abrupt("return", fetch(endpoint).then(function (result) {
                  return result.json();
                }).then(function (data) {
                  return data;
                }));
...
exports.default = _default;
},{"../../../../firebase/authentication.js":"../firebase/authentication.js","../store/index.js":"static/js/store/index.js","./AbstractView.js":"static/js/views/AbstractView.js"}],"static/js/views/Home.js":[function(require,module,exports) {
"use strict";
...
var _Ranking = _interopRequireDefault(require("./Ranking.js"));
...
var _default = /*#__PURE__*/function (_AbstractView) {
  ...
  _createClass(_default, [{
    ...
    value: function () {
      var _renderHTML = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var title, quizType, description;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                this.ranking = new _Ranking.default();
                this.hideAppNode();
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.t0 = document.querySelector(".rank-in-home");
                _context3.next = 4;
                return this.ranking.renderHTML();

              case 4:
                _context3.t1 = _context3.sent;

                _context3.t0.append.call(_context3.t0, _context3.t1);

                _context3.t2 = this.app.innerHTML;
                _context3.next = 9;
                return this.footer.renderHTML();

              case 9:
                this.app.innerHTML = _context3.t2 += _context3.sent;
...
exports.default = _default;
},{"./AbstractView.js":"static/js/views/AbstractView.js","./Footer.js":"static/js/views/Footer.js","./Ranking.js":"static/js/views/Ranking.js"}],"static/js/views/Login.js":[function(require,module,exports) {
"use strict";
...
var _default = /*#__PURE__*/function (_AbstractView) {
  ...
  _createClass(_default, [{
    ...
    key: "loginUser",
    value: function () {
      var _loginUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
        var _this3 = this;

        var inputValues, user, formCheck;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                inputValues = document.querySelectorAll(".form-input");
                e.preventDefault();
                ...
                if (formCheck) {
                  (0, _authentication.login)(user).then(function () {
                    history.go();
                  }).catch(function (e) {
                    _this3.formError.push(e.errorCode);
    ...
    key: "errorHandler",
    value: function () {
      var _errorHandler = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        var title, color, notify;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
...
exports.default = _default;
},{"../../../../firebase/authentication.js":"../firebase/authentication.js","./AbstractView.js":"static/js/views/AbstractView.js","./PopupNotification.js":"static/js/views/PopupNotification.js"}],"static/js/views/Quiz.js":[function(require,module,exports) {
"use strict";
...
var allQuestion = [];
var allTerm = [];
var frontURL = "https://fathomless-inlet-02114.herokuapp.com/";

var SetQuiz = /*#__PURE__*/_createClass(function SetQuiz(obj) {
  _classCallCheck(this, SetQuiz);
...
var _default = /*#__PURE__*/function (_AbstractView) {
  ...
  function _default() {
    ...
    _this.app = document.querySelector("#app");
    _this.quizComponentDom;
    _this.url = _index.fixedUrl;
    _this.path = "/api/quiz/js";
    _this.endpoint = _this.url + _this.path;
    _this.progress = 0;
    _this.correctNum = 0;
    _this.intervalId;
    _this.apiData;
    _this.timer;
    _this.questionWrapper;
    _this.userLogin = (0, _authentication.getUserLogin)();
    _this.userData = (0, _authentication.getUserData)();
    return _this;
  }
  ...
  _createClass(_default, [{
              ...
              case 0:
                ...
                return new Promise(function () {
                  _this3.intervalId = setInterval(function () {
                    if (startSecond > 1) {
                      startSecond -= 1;
                      _this3.quizComponentDom.innerHTML = "<div class=\"start-countdown\">".concat(startSecond, "</div>");
                    } else if (startSecond == 1) {
                      _this3.quizComponentDom.innerHTML = "<div class=\"start-countdown-start\">START!</div>";
                      startSecond -= 1;
                    } else {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return fetch(this.endpoint).then(function (result) {
                  return result.json();
                }).then(function (data) {
                  _this4.apiData = data;
                });
    ...
    value: function setQuiz() {
      ...
      allQuestion.forEach(function (obj) {
        while (obj.choices.length < 4) {
          var term = allTerm[Math.floor(Math.random() * allTerm.length)];
          obj.choices.push(term);
          obj.choices = _this5.shaffleArray(Array.from(_this5.setLength(obj.choices)));
        }
      });
    ...
    key: "quizProgress",
    value: function quizProgress() {
      var _this6 = this;

      var lebal = allQuestion[this.progress].label;
      var choiceOne = allQuestion[this.progress].choices[0];
      var choiceTwo = allQuestion[this.progress].choices[1];
      var choiceThree = allQuestion[this.progress].choices[2];
      var choiceFour = allQuestion[this.progress].choices[3];
      var questionHTML = "\n      <div class=\"question-wrapper\">\n        <div class=\"lable-container\">\n          <div class=\"question-num\">Q, ".concat(this.progress + 1, "</div>\n          <label>").concat(lebal, "</label>\n        </div>\n          <button class=\"each-choice\" id=\"").concat(choiceOne, "\"><div class=\"order\">1</div><div class=\"choice\">").concat(choiceOne, "</div></button>\n          <button class=\"each-choice\" id=\"").concat(choiceTwo, "\"><div class=\"order\">2</div><div class=\"choice\">").concat(choiceTwo, "</div></button>\n          <button class=\"each-choice\" id=\"").concat(choiceThree, "\"><div class=\"order\">3</div><div class=\"choice\">").concat(choiceThree, "</div></button>\n          <button class=\"each-choice\" id=\"").concat(choiceFour, "\"><div class=\"order\">4</div><div class=\"choice\">").concat(choiceFour, "</div></button>\n      </div>");
      this.quizComponentDom.innerHTML = questionHTML; // console.log("ANSWER", allQuestion[this.progress].answer);

      var choices = document.querySelectorAll(".each-choice");

      var _loop = function _loop(i) {
        choices[i].addEventListener("click", function (e) {
          clearInterval(_this6.intervalId); //set style for clicked choice

          choices[i].style.background = "gray";
          choices[i].style.color = "white";
          choices[i].style.border = "solid orange"; // stop hover

          _this6.questionWrapper = document.querySelector(".question-wrapper");
          _this6.questionWrapper.style.pointerEvents = "none";

          if (allQuestion[_this6.progress].answer == e.target.id) {
            _this6.correctNum += 1;
            _this6.progress += 1;
            _this6.quizComponentDom.innerHTML += "<i id=\"font\" class=\"fas fa-thumbs-up\"></i>";

            if (allQuestion.length == _this6.progress) {
              _this6.stop();
            } else {
              _this6.intervalId = setTimeout(function () {
                _this6.quizProgress(), _this6.countdown();
              }, 2000);
            }
          } else {
            _this6.quizComponentDom.innerHTML += "<i id=\"font\" class=\"fas fa-times\"></i>";
    ...
    value: function countdown() {
      ...
      this.timer.innerHTML = "<div class=\"base-count-num\">".concat(startSecond, "</div> <div class=\"second-left\">second left...</div>");
      this.intervalId = setInterval(function () {
        var singularOrPlural = startSecond === 1 + 1 ? "second" : "seconds";
        var greaterThanThree = startSecond > 3 + 1 ? "base-count-num" : "last-three";

        if (startSecond > 0) {
          startSecond -= 1;
          _this7.timer.innerHTML = "<div class=".concat(greaterThanThree, ">").concat(startSecond, "</div> <div class=\"second-left\">").concat(singularOrPlural, " left...</div>");
        } else {
          clearInterval(_this7.intervalId);
    ...
    value: function stop() {
      ...
      var resultHTML = "\n            <div class=\"relust-container\">\n            <div class=\"score-text\">".concat(message, "\n            <span class=\"score-num\"></span>\n            </div>\n            <div class=\"result-footer-container\"></div>\n            </div>\n        ");
      new Promise(function (resolve, reject) {
        _this8.intervalId = setTimeout(function () {
          _this8.timer.innerHTML = "";
          _this8.quizComponentDom.innerHTML = resultHTML;
        ...
        return new Promise(function (resolve, reject) {
          _this8.intervalId = setTimeout(function () {
            score.innerHTML = _this8.correctNum;
            resolve();
          }, 1000);
        });
      }).then(function () {
        ...
        _this8.intervalId = setTimeout(function () {
          var resultContainer = document.querySelector(".relust-container");
          var resultFooterContainer = document.querySelector(".result-footer-container");
          ...
          if (_this8.userLogin) {
            ...
            html = "\n                  <div class=\"footer-section\">\n                      <div>Register? your score sould be in the Ranking!</div>\n                      <div class=\"register-button\" target-url=\"/signup?score=".concat(_this8.correctNum, "\">Register</div>\n                  </div>\n                  ");
          }

          var registerHtml = "<div class=\"try-again-button\" target-url=\"/quiz\">Try Again!</div>";
          ...
          document.querySelector(".social-img").addEventListener("click", function () {
            var shareURL = "https://twitter.com/intent/tweet?text=" + "%23" + "RankingQuizDojo" + "%20%0a" + "Your score is " + _this8.correctNum + "%0a" + "&url=" + "".concat(frontURL);
    ...
    key: "updateScore",
    value: function () {
      var _updateScore = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        var _this9 = this;

        var url, scorePath, scoreEndpoint, maxScore;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                scorePath = "/api/score";
                scoreEndpoint = url + scorePath;
                maxScore = (0, _index.getSessionItem)("currentScore");
                ...
                return fetch(scoreEndpoint, {
                  ...
                  (0, _index.setSessionStorage)("currentScore", _this9.correctNum);
                });
    ...
    key: "shaffleArray",
    value: function shaffleArray(array) {
    ...
    key: "setLength",
    value: function setLength(array) {
...
exports.default = _default;
},{"./AbstractView.js":"static/js/views/AbstractView.js","../../../../firebase/authentication.js":"../firebase/authentication.js","../store/index.js":"static/js/store/index.js"}],"static/js/views/Signup.js":[function(require,module,exports) {
"use strict";
...
var _default = /*#__PURE__*/function (_AbstractView) {
  ...
  function _default() {
    ...
    _this.setTitle("Signup");

    _this.score = document.location.search.substring(1).split("=")[1];
    _this.app = document.querySelector("#app");
    _this.url = _index.fixedUrl;
    _this.userPath = "/api/user";
    _this.scorePath = "/api/score";
    _this.userEndpoint = _this.url + _this.userPath;
    _this.scoreEndpoint = _this.url + _this.scorePath;
    _this.formError = [];
    _this.inputValues;
    _this.mainNode;
    _this.submitButton;
  ...
  _createClass(_default, [{
    ...
    value: function initialEvent() {
      ...
      this.submitButton = document.querySelector(".signup-submit-button");
      this.submitButton.addEventListener("click", function (e) {
        return _this2.signupUser(e, _this2.scoreEndpoint);
      });
      this.mainNode = document.querySelector(".signup-wrapper");
    ...
    key: "signupUser",
    value: function () {
      var _signupUser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e) {
        var _this3 = this;

        var formCheck, user, title, color, notify;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                (0, _authentication.createUser)(user).then(function (e) {
                  var userData = (0, _authentication.getUserData)();
                  user["uid"] = userData.UID;
                  fetch(_this3.scoreEndpoint, {
                    method: "POST",
                    body: JSON.stringify({
                      UUID: user.uid,
                  ...
                  return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                    while (1) {
                      switch (_context2.prev = _context2.next) {
                        case 0:
                          _context2.next = 2;
                          return fetch(_this3.userEndpoint, {
                            method: "POST",
                            body: JSON.stringify({
                              UUID: user.uid,
                              user: user.username,
                        ...
                        case 2:
                          (0, _index.setSessionStorage)("currentScore", _this3.score);
                          window.removeEventListener("beforeunload", _this3.callback, true);
    ...
    key: "errorHandler",
    value: function () {
      var _errorHandler = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        var title, color, notify;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
...
exports.default = _default;
},{"../../../../firebase/authentication.js":"../firebase/authentication.js","../store/index.js":"static/js/store/index.js","./AbstractView.js":"static/js/views/AbstractView.js","./PopupNotification.js":"static/js/views/PopupNotification.js"}],"static/js/views/Study.js":[function(require,module,exports) {
"use strict";
...
var _default = /*#__PURE__*/function (_AbstractView) {
  ...
  _createClass(_default, [{
    ...
    value: function result(results) {
      ...
      if (results.length) {
        this.num.innerHTML = "<div aria-live=\"polite\" class=\"num\">".concat(results.length, " terms found</div>");
        results.forEach(function (result) {
          _this5.currentDom.push(result);

          _this5.container.innerHTML += '<div aria-live="polite" class="each-item"></div>';
          var each = document.querySelectorAll(".each-item");
...
exports.default = _default;
},{"../store/index.js":"static/js/store/index.js","./AbstractView.js":"static/js/views/AbstractView.js"}],"static/js/index.js":[function(require,module,exports) {
"use strict";
...
exports.routingEvent = routingEvent;

var _authentication = require("../../../firebase/authentication.js");

var _index = _interopRequireWildcard(require("./store/index.js"));
...
var _Quiz = _interopRequireDefault(require("./views/Quiz.js"));

var _Signup = _interopRequireDefault(require("./views/Signup.js"));

var _Study = _interopRequireDefault(require("./views/Study.js"));
...
function setAuth(routeObj) {
  var isAuth = (0, _index.getIsAuth)() ? true : false; // Because DB return 1 or 0

  var userLogin = (0, _authentication.getUserLogin)();
  var returnVal;

  for (var i = 0; i < Object.keys(routeObj.auth).length; i++) {
...
var router = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var potentialMatches, match, view;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            potentialMatches = routes.map(function (route) {
              var auth = "auth" in route && location.pathname === route.path ? setAuth(route) : false;
              return {
                route: route,
            ...
            cancelAppStyle();
            view = new match.route.view(); //make a new instance

            _context.next = 7;
            return view.beforeInitialRender();
          ...
          case 9:
            ...
            // renderHTML() is async so await here
            view.initialEvent();
...
window.addEventListener("popstate", router); // postate excute histrical data when browser back or forward
// the data could be the data created with histry.pushState
},{"../../../firebase/authentication.js":"../firebase/authentication.js","./store/index.js":"static/js/store/index.js","./views/dashboard/Dashboard.js":"static/js/views/dashboard/Dashboard.js","./views/Home.js":"static/js/views/Home.js","./views/Login.js":"static/js/views/Login.js","./views/Quiz.js":"static/js/views/Quiz.js","./views/Signup.js":"static/js/views/Signup.js","./views/Study.js":"static/js/views/Study.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","static/js/index.js"], null)
//# sourceMappingURL=/js.ecb796d1.js.map