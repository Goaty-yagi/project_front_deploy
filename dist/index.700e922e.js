...
})({"3dAzu":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "bc09b43c700e922e";
...
},{}],"5nPzB":[function(require,module,exports) {
...
parcelHelpers.export(exports, "routingEvent", ()=>routingEvent);
parcelHelpers.export(exports, "router", ()=>router);
var _authenticationJs = require("../../../firebase/authentication.js");
var _indexJs = require("./store/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
var _dashboardJs = require("./views/dashboard/Dashboard.js");
...
var _loginJs = require("./views/Login.js");
var _loginJsDefault = parcelHelpers.interopDefault(_loginJs);
var _quizJs = require("./views/Quiz.js");
...
var _studyJs = require("./views/Study.js");
var _studyJsDefault = parcelHelpers.interopDefault(_studyJs);
...
const routes = [
    ...
    {
        path: "/quiz",
        view: (0, _quizJsDefault.default)
    },
    {
        path: "/dashboard",
        view: (0, _dashboardJsDefault.default),
        auth: {
            userLogin: true,
            isAuth: true
        }
    ...
    {
        path: "/signup",
        view: (0, _signupJsDefault.default),
        auth: {
            userLogin: false
        }
    },
    {
        path: "/login",
        view: (0, _loginJsDefault.default),
        auth: {
            userLogin: false
        }
    },
    {
        path: "/study",
        view: (0, _studyJsDefault.default)
    }, 
];
...
function setAuth(routeObj) {
    const isAuth = (0, _indexJs.getIsAuth)() ? true : false; // Because DB return 1 or 0
    const userLogin = (0, _authenticationJs.getUserLogin)();
    let returnVal;
    for(let i = 0; i < Object.keys(routeObj.auth).length; i++){
        if (Object.keys(routeObj.auth)[i] === "userLogin" && routeObj.auth.userLogin !== userLogin) returnVal = true;
        else if (Object.keys(routeObj.auth)[i] === "isAuth" && routeObj.auth.isAuth !== isAuth) returnVal = true;
...
const router = async ()=>{
    ...
    const potentialMatches = routes.map((route)=>{
        const auth = "auth" in route && location.pathname === route.path ? setAuth(route) : false;
        return {
            route: route,
...
},{"../../../firebase/authentication.js":"61l5e","./store/index.js":"h1SHO","./views/dashboard/Dashboard.js":"2eoDL","./views/Home.js":"3NvlB","./views/Login.js":"6u9M3","./views/Quiz.js":"1Mj4w","./views/Signup.js":"3yuwC","./views/Study.js":"jlceo","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"61l5e":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "getUserLogin", ()=>getUserLogin);
var _config = require("./config");
var _auth = require("firebase/auth");
var _store = require("../frontend/static/js/store");
...
async function createUser(user) {
    return new Promise(async (resolve, reject)=>{
        ...
        await (0, _auth.createUserWithEmailAndPassword)((0, _config.auth), email, password).then(async ()=>{
            await (0, _auth.updateProfile)((0, _config.auth).currentUser, {
...
function login(user) {
    return new Promise((resolve, reject)=>{
        ...
        (0, _auth.signInWithEmailAndPassword)((0, _config.auth), email, password).then(()=>{
            // Signed in
            resolve();
        }).catch((error)=>{
            const FBError = {
...
async function logout() {
    await (0, _auth.signOut)((0, _config.auth));
    (0, _store.removeSessionItem)("currentScore");
}
function authChange() {
    (0, _auth.onAuthStateChanged)((0, _config.auth), async (user)=>{
        setUser(user);
        if (user) (0, _storeDefault.default)(userLogin, user.uid);
        else (0, _storeDefault.default)(userLogin);
    });
}
authChange();

},{"./config":"i8Fix","firebase/auth":"drt1f","../frontend/static/js/store":"h1SHO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"i8Fix":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const auth = (0, _auth.getAuth)(firebaseApp) // const db = getFirestore(firebaseApp)
;
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ActionCodeOperation", ()=>(0, _index90EbcfaeJs.A));
parcelHelpers.export(exports, "ActionCodeURL", ()=>(0, _index90EbcfaeJs.ad));
parcelHelpers.export(exports, "AuthCredential", ()=>(0, _index90EbcfaeJs.H));
parcelHelpers.export(exports, "AuthErrorCodes", ()=>(0, _index90EbcfaeJs.D));
parcelHelpers.export(exports, "EmailAuthCredential", ()=>(0, _index90EbcfaeJs.I));
parcelHelpers.export(exports, "EmailAuthProvider", ()=>(0, _index90EbcfaeJs.M));
parcelHelpers.export(exports, "FacebookAuthProvider", ()=>(0, _index90EbcfaeJs.N));
parcelHelpers.export(exports, "FactorId", ()=>(0, _index90EbcfaeJs.F));
parcelHelpers.export(exports, "GithubAuthProvider", ()=>(0, _index90EbcfaeJs.T));
parcelHelpers.export(exports, "GoogleAuthProvider", ()=>(0, _index90EbcfaeJs.Q));
parcelHelpers.export(exports, "OAuthCredential", ()=>(0, _index90EbcfaeJs.J));
parcelHelpers.export(exports, "OAuthProvider", ()=>(0, _index90EbcfaeJs.U));
parcelHelpers.export(exports, "OperationType", ()=>(0, _index90EbcfaeJs.O));
parcelHelpers.export(exports, "PhoneAuthCredential", ()=>(0, _index90EbcfaeJs.K));
parcelHelpers.export(exports, "PhoneAuthProvider", ()=>(0, _index90EbcfaeJs.P));
parcelHelpers.export(exports, "PhoneMultiFactorGenerator", ()=>(0, _index90EbcfaeJs.m));
parcelHelpers.export(exports, "ProviderId", ()=>(0, _index90EbcfaeJs.o));
parcelHelpers.export(exports, "RecaptchaVerifier", ()=>(0, _index90EbcfaeJs.R));
parcelHelpers.export(exports, "SAMLAuthProvider", ()=>(0, _index90EbcfaeJs.V));
parcelHelpers.export(exports, "SignInMethod", ()=>(0, _index90EbcfaeJs.S));
parcelHelpers.export(exports, "TwitterAuthProvider", ()=>(0, _index90EbcfaeJs.W));
parcelHelpers.export(exports, "applyActionCode", ()=>(0, _index90EbcfaeJs.a2));
parcelHelpers.export(exports, "beforeAuthStateChanged", ()=>(0, _index90EbcfaeJs.t));
parcelHelpers.export(exports, "browserLocalPersistence", ()=>(0, _index90EbcfaeJs.b));
parcelHelpers.export(exports, "browserPopupRedirectResolver", ()=>(0, _index90EbcfaeJs.k));
parcelHelpers.export(exports, "browserSessionPersistence", ()=>(0, _index90EbcfaeJs.a));
parcelHelpers.export(exports, "checkActionCode", ()=>(0, _index90EbcfaeJs.a3));
parcelHelpers.export(exports, "confirmPasswordReset", ()=>(0, _index90EbcfaeJs.a1));
parcelHelpers.export(exports, "connectAuthEmulator", ()=>(0, _index90EbcfaeJs.G));
parcelHelpers.export(exports, "createUserWithEmailAndPassword", ()=>(0, _index90EbcfaeJs.a5));
parcelHelpers.export(exports, "debugErrorMap", ()=>(0, _index90EbcfaeJs.B));
parcelHelpers.export(exports, "deleteUser", ()=>(0, _index90EbcfaeJs.z));
parcelHelpers.export(exports, "fetchSignInMethodsForEmail", ()=>(0, _index90EbcfaeJs.aa));
parcelHelpers.export(exports, "getAdditionalUserInfo", ()=>(0, _index90EbcfaeJs.al));
parcelHelpers.export(exports, "getAuth", ()=>(0, _index90EbcfaeJs.n));
parcelHelpers.export(exports, "getIdToken", ()=>(0, _index90EbcfaeJs.ai));
parcelHelpers.export(exports, "getIdTokenResult", ()=>(0, _index90EbcfaeJs.aj));
parcelHelpers.export(exports, "getMultiFactorResolver", ()=>(0, _index90EbcfaeJs.an));
parcelHelpers.export(exports, "getRedirectResult", ()=>(0, _index90EbcfaeJs.j));
parcelHelpers.export(exports, "inMemoryPersistence", ()=>(0, _index90EbcfaeJs.L));
parcelHelpers.export(exports, "indexedDBLocalPersistence", ()=>(0, _index90EbcfaeJs.i));
parcelHelpers.export(exports, "initializeAuth", ()=>(0, _index90EbcfaeJs.E));
parcelHelpers.export(exports, "isSignInWithEmailLink", ()=>(0, _index90EbcfaeJs.a8));
parcelHelpers.export(exports, "linkWithCredential", ()=>(0, _index90EbcfaeJs.Z));
parcelHelpers.export(exports, "linkWithPhoneNumber", ()=>(0, _index90EbcfaeJs.l));
parcelHelpers.export(exports, "linkWithPopup", ()=>(0, _index90EbcfaeJs.d));
parcelHelpers.export(exports, "linkWithRedirect", ()=>(0, _index90EbcfaeJs.g));
parcelHelpers.export(exports, "multiFactor", ()=>(0, _index90EbcfaeJs.ao));
parcelHelpers.export(exports, "onAuthStateChanged", ()=>(0, _index90EbcfaeJs.v));
parcelHelpers.export(exports, "onIdTokenChanged", ()=>(0, _index90EbcfaeJs.q));
parcelHelpers.export(exports, "parseActionCodeURL", ()=>(0, _index90EbcfaeJs.ae));
parcelHelpers.export(exports, "prodErrorMap", ()=>(0, _index90EbcfaeJs.C));
parcelHelpers.export(exports, "reauthenticateWithCredential", ()=>(0, _index90EbcfaeJs._));
parcelHelpers.export(exports, "reauthenticateWithPhoneNumber", ()=>(0, _index90EbcfaeJs.r));
parcelHelpers.export(exports, "reauthenticateWithPopup", ()=>(0, _index90EbcfaeJs.e));
parcelHelpers.export(exports, "reauthenticateWithRedirect", ()=>(0, _index90EbcfaeJs.h));
parcelHelpers.export(exports, "reload", ()=>(0, _index90EbcfaeJs.am));
parcelHelpers.export(exports, "sendEmailVerification", ()=>(0, _index90EbcfaeJs.ab));
parcelHelpers.export(exports, "sendPasswordResetEmail", ()=>(0, _index90EbcfaeJs.a0));
parcelHelpers.export(exports, "sendSignInLinkToEmail", ()=>(0, _index90EbcfaeJs.a7));
parcelHelpers.export(exports, "setPersistence", ()=>(0, _index90EbcfaeJs.p));
parcelHelpers.export(exports, "signInAnonymously", ()=>(0, _index90EbcfaeJs.X));
parcelHelpers.export(exports, "signInWithCredential", ()=>(0, _index90EbcfaeJs.Y));
parcelHelpers.export(exports, "signInWithCustomToken", ()=>(0, _index90EbcfaeJs.$));
parcelHelpers.export(exports, "signInWithEmailAndPassword", ()=>(0, _index90EbcfaeJs.a6));
parcelHelpers.export(exports, "signInWithEmailLink", ()=>(0, _index90EbcfaeJs.a9));
parcelHelpers.export(exports, "signInWithPhoneNumber", ()=>(0, _index90EbcfaeJs.s));
parcelHelpers.export(exports, "signInWithPopup", ()=>(0, _index90EbcfaeJs.c));
parcelHelpers.export(exports, "signInWithRedirect", ()=>(0, _index90EbcfaeJs.f));
parcelHelpers.export(exports, "signOut", ()=>(0, _index90EbcfaeJs.y));
parcelHelpers.export(exports, "unlink", ()=>(0, _index90EbcfaeJs.ak));
parcelHelpers.export(exports, "updateCurrentUser", ()=>(0, _index90EbcfaeJs.x));
parcelHelpers.export(exports, "updateEmail", ()=>(0, _index90EbcfaeJs.ag));
parcelHelpers.export(exports, "updatePassword", ()=>(0, _index90EbcfaeJs.ah));
parcelHelpers.export(exports, "updatePhoneNumber", ()=>(0, _index90EbcfaeJs.u));
parcelHelpers.export(exports, "updateProfile", ()=>(0, _index90EbcfaeJs.af));
parcelHelpers.export(exports, "useDeviceLanguage", ()=>(0, _index90EbcfaeJs.w));
parcelHelpers.export(exports, "verifyBeforeUpdateEmail", ()=>(0, _index90EbcfaeJs.ac));
parcelHelpers.export(exports, "verifyPasswordResetCode", ()=>(0, _index90EbcfaeJs.a4));
var _util = require("@firebase/util");
var _app = require("@firebase/app");
var _tslib = require("tslib");
var _logger = require("@firebase/logger");
var _component = require("@firebase/component");
var _index90EbcfaeJs = require("./index-90ebcfae.js");

},{"@firebase/util":"ePiK6","@firebase/app":"3AcPV","tslib":"lRdW5","@firebase/logger":"fZmft","@firebase/component":"bi1VB","./index-90ebcfae.js":"3zWZm","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lRdW5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3zWZm":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@firebase/util":"ePiK6","@firebase/app":"3AcPV","tslib":"lRdW5","@firebase/logger":"fZmft","@firebase/component":"bi1VB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"h1SHO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "setSessionStorage", ()=>setSessionStorage);
parcelHelpers.export(exports, "getSessionItem", ()=>getSessionItem);
parcelHelpers.export(exports, "removeSessionItem", ()=>removeSessionItem);
parcelHelpers.export(exports, "fetchScoreData", ()=>fetchScoreData);
parcelHelpers.export(exports, "getIsAuth", ()=>getIsAuth);
var _indexJs = require("../index.js");
var _navJs = require("../views/Nav.js");
var _navJsDefault = parcelHelpers.interopDefault(_navJs);
let initialized = false;
let is_auth = false;
async function initialization(userLogin, uid) {
    if (uid) {
        await fetchScoreData(uid);
        await getUserData(uid);
    }
    if (!initialized) {
        (0, _indexJs.routingEvent)();
        const nav = new (0, _navJsDefault.default)();
...
async function fetchScoreData(uid) {
    ...
    await fetch(scoreEndpoint, {}).then((result)=>{
        return result.json();
    }).then((data)=>{
...
async function getUserData(uid) {
    ...
    await fetch(userEndpoint, {}).then((result)=>{
        return result.json();
    }).then((data)=>{
...
},{"../index.js":"5nPzB","../views/Nav.js":"dhO4h","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dhO4h":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _backgroundDarkPng = require("../../images/background-dark.png");
var _backgroundDarkPngDefault = parcelHelpers.interopDefault(_backgroundDarkPng);
var _backgroundLightPng = require("../../images/background-light.png");
var _backgroundLightPngDefault = parcelHelpers.interopDefault(_backgroundLightPng);
var _authenticationJs = require("../../../../firebase/authentication.js");
var _indexJs = require("../store/index.js");
exports.default = class extends (0, _abstractViewJsDefault.default) {
    constructor(){
        super();
        this.clickedTheme = false;
        this.userLogin = (0, _authenticationJs.getUserLogin)();
        this.isAuth = (0, _indexJs.getIsAuth)();
    }
    async renderHTML() {
        const headerElement = document.querySelector("#header");
        headerElement.innerHTML = `<img target-url="/" class="logo" src="${0, _logoPngDefault.default}" alt="logo">`;
      ...
      `;
        if (this.userLogin) {
            if (this.isAuth) headerElement.children[1].innerHTML += `
        ...
        `;
            ...
            document.querySelector(".logout").addEventListener("click", ()=>{
                (0, _authenticationJs.logout)();
                history.go();
            });
        } else headerElement.children[1].innerHTML += `
    ...
    theme() {
        ...
        if (this.clickedTheme) {
            ...
            body.style.backgroundImage = `url("${0, _backgroundDarkPngDefault.default}")`;
            ...
            body.style.backgroundImage = `url("${0, _backgroundLightPngDefault.default}")`;
...
},{"./AbstractView.js":"jv4Eo","../../images/logo.png":"8EUHx","../../images/background-dark.png":"bsxF0","../../images/background-light.png":"eMgKO","../../../../firebase/authentication.js":"61l5e","../store/index.js":"h1SHO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jv4Eo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
//............life-sycle-fook................
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8EUHx":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("g8V7I") + "logo.f96c776e.png" + "?" + Date.now();
...
},{}],"bsxF0":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("g8V7I") + "background-dark.f26d981c.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"eMgKO":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("g8V7I") + "background-light.6b2db0b2.png" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"2eoDL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _abstractViewJs = require("../AbstractView.js");
var _abstractViewJsDefault = parcelHelpers.interopDefault(_abstractViewJs);
var _allQuestionsJs = require("./AllQuestions.js");
var _allQuestionsJsDefault = parcelHelpers.interopDefault(_allQuestionsJs);
var _quizCreateJs = require("./QuizCreate.js");
var _quizCreateJsDefault = parcelHelpers.interopDefault(_quizCreateJs);
exports.default = class extends (0, _abstractViewJsDefault.default) {
    constructor(){
        super();
    ...
    async initialEvent() {
        ...
        for(let i = 0; i < this.headerMenues.length; i++)this.headerMenues[i].addEventListener("click", (e)=>{
    ...
    async allQuestions() {
        const instance = new (0, _allQuestionsJsDefault.default)();
        this.dashboardContainer.innerHTML = await instance.renderHTML();
        instance.initialEvent();
    }
    async createQuestions() {
        const instance = new (0, _quizCreateJsDefault.default)();
        this.dashboardContainer.innerHTML = await instance.renderHTML();
        instance.initialEvent();
    }
...
},{"../AbstractView.js":"jv4Eo","./AllQuestions.js":"au9ZL","./QuizCreate.js":"e26In","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"au9ZL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _abstractViewJs = require("../AbstractView.js");
var _abstractViewJsDefault = parcelHelpers.interopDefault(_abstractViewJs);
var _popupNotificationJs = require("../PopupNotification.js");
var _popupNotificationJsDefault = parcelHelpers.interopDefault(_popupNotificationJs);
0, _abstractViewJsDefault.default;
exports.default = class extends (0, _abstractViewJsDefault.default) {
    constructor(){
        super();
        this.apiData;
    ...
    async initialEvent() {
        ...
        await this.fetchQuizData().then(()=>{
            ...
            for(let i = 0; i < this.allChecks.length; i++)this.allChecks[i].addEventListener("change", (e)=>this.firstSearch(e));
        });
    }
    async fetchQuizData() {
        const url = "http://localhost:5000";
        ...
        await fetch(endpoint).then((result)=>{
            return result.json();
        }).then((data)=>this.apiData = data).catch((e)=>{
            console.log("ERR", e);
        });
    }
    getSelectOption() {
    ...
    getClassOption() {
        let set = new Set();
        for(let i = 0; i <= this.apiData.length - 1; i++)set.add(this.apiData[i].class);
    ...
    firstSearch(e) {
        ...
        const textSearch = (value, array = [])=>{
            if (array.length) gs = array;
            for(let i = 0; i <= gs.length - 1; i++)Object.values(gs[i]).forEach((elem)=>{
                if (Array.isArray(elem)) elem.forEach((e)=>{
                    if (e.toLowerCase().indexOf(value.toLowerCase()) !== -1) set.add(gs[i]);
                });
                else if (typeof elem != "number") {
                    if (elem.toLowerCase().indexOf(value.toLowerCase()) !== -1) set.add(gs[i]);
                } else if (elem == value) set.add(gs[i]);
            });
        ...
        const classSearch = (value, array = [])=>{
            if (value) {
                if (array.length) gs = array;
                for(let i = 0; i <= gs.length - 1; i++)if (gs[i].class == value) set.add(gs[i]);
        ...
        const tagSearch = ()=>{
            for(let i = 0; i <= gs.length - 1; i++)Object.keys(gs[i]).forEach((elem)=>{
                if (elem === "tags") {
                    let tagArray = this.tagsStringToArray(gs[i]);
                    tagArray.forEach((e)=>{
                        this.currentData.tags.forEach((t)=>{
                            if (e.indexOf(t) !== -1) set.add(gs[i]);
                        });
                    });
                }
            });
        ...
        const centerSearch = (event)=>{
            ...
            if (event.target.type == "text") this.currentData.text = event.target.value;
            else if (event.target.type == "select-one") this.currentData.class = event.target.value;
            else if (event.target.type == "checkbox") {
                if (event.target.checked) this.currentData.tags.push(event.target.id);
                else this.currentData.tags.forEach((e)=>{
                    if (e == event.target.id) this.currentData.tags = this.currentData.tags.filter((t)=>t != e);
                });
            }
            if (this.currentData.tags.length) baseArrayForSearch = tagSearch();
            else if (this.currentData.class) baseArrayForSearch = classSearch(this.currentData.class);
            if (this.currentData.tags.length) Object.keys(this.currentData).forEach((key)=>{
                set = new Set();
                if (key == "class") {
                    if (this.currentData.class) baseArrayForSearch = classSearch(this.currentData.class, baseArrayForSearch);
                } else if (key == "text") {
                    if (this.currentData.text) {
                        baseArrayForSearch = textSearch(this.currentData.text, baseArrayForSearch);
                        // bag occur here
                        // whenever class and tags selected, then put text.
                        // when textSearch return empty array, baseArrayForSearch will have objects
                        // before set
                        // below is solution
                        if (!baseArrayForSearch.length) textEmpty = true;
                    }
                }
            });
            else {
                if (!baseArrayForSearch.length) baseArrayForSearch = this.apiData;
                set = new Set();
                baseArrayForSearch = textSearch(this.currentData.text, baseArrayForSearch);
            }
            if (textEmpty) baseArrayForSearch = [];
        ...
        if (e.target.type == "checkbox") {
            ...
            if (this.currentDataExist) {
                if (this.currentData.tags.length && !this.currentData.text && !this.currentData.class) {
                    ...
                    } else if (this.currentData.tags.length == 1) {
                ...
                } else arrayForResult = centerSearch(e);
            } else {
                this.currentData.tags.push(e.target.id);
                arrayForResult = tagSearch(e);
            }
            ...
            if (this.currentDataExist) {
                if (this.currentData.class && !this.currentData.text && !this.currentData.tags.length) {
                    if (e.target.value) arrayForResult = classSearch(e.target.value);
                    else this.remove(e.target);
                } else arrayForResult = centerSearch(e);
            } else arrayForResult = classSearch(e.target.value);
        } else if (e.target.type == "text") {
            if (this.currentDataExist) {
                if (this.currentData.text && !this.currentData.class && !this.currentData.tags.length) {
                    if (e.target.value) arrayForResult = textSearch(e.target.value);
                    else this.remove(e.target);
                } else arrayForResult = centerSearch(e);
            } else arrayForResult = textSearch(e.target.value);
        }
    ...
    checkCurrentItem = ()=>{
        ...
        if (counter == 0) {
            this.currentDataExist = false;
            this.num.innerHTML = "";
        } else if (!this.currentDom.length) this.num.innerHTML = `<div aria-live="polite" class="no-num">no terms found</div>`;
        counter = 0;
    };
    result(results) {
            ...
            <div id=${result.UUID} class="delete-question-container">
              <i class="fas fa-times delete-question"></i>
                ...
                this.keysArray.forEach((e)=>{
                    if (e !== "tags") each[each.length - 1].innerHTML += `
                <div class="category">
                  <p class="title">${e}:</p>
                ...
                for(let i = 0; i < patchDoms.length; i++)patchDoms[i].addEventListener("click", (e)=>this.patchHandler(e));
            });
        } else this.remove();
        this.checkCurrentItem();
        this.deleteQuestion();
    ...
    remove(target) {
        ...
        if (!target) allRemove();
            ...
            if (target.type == "text") {
                if (!target.value) allRemove();
                else for(let i = 0; i < allItems.length; i++){
                    for(let k = 0; k < allItems[i].children.length; k++)if (allItems[i].children[k].textContent.toLowerCase().includes(currentData.text)) {
                        allItems[i].remove();
                ...
                if (!target.value) allRemove();
                    ...
                    for(let i1 = 0; i1 < allItems.length; i1++)if (allItems[i1].children[1].textContent == this.currentData.class) {
                        allItems[i1].remove();
                        this.currentDom.splice(i1);
                    }
                }
                this.currentData.class = "";
            } else if (target.type == "checkbox") {
                for(let i2 = 0; i2 < allItems.length; i2++)if (allItems[i2].children[3].innerHTML.includes(target.id)) {
                    allItems[i2].remove();
                    this.currentDom.splice(i2);
                }
            }
            this.checkCurrentItem();
        }
    ...
    _selectorEvent() {
        ...
        selecterBox.addEventListener("click", ()=>{
            if (!this.windowIsOpen) for(let i = 0; i < this.tagsArray.length; i++){
    ...
    _checkForm(inputValues) {
        for(let i = 0; i < inputValues.length; i++)if (!inputValues[i].value) this.formError.push(`${inputValues[i].name} is empty.`);
        if (!this.chosenTags.length) this.formError.push(`tag is empty.`);
        if (this.formError.length) return false;
        else return true;
    }
    closeEditModal() {
    ...
    async patchQuestion() {
        ...
        if (formCheck) {
            ...
            await fetch(endpoint, {
                ...
                this.allReset();
                const notify = new (0, _popupNotificationJsDefault.default)([], "UPLOADED", this.mainNode, "success");
                this.closeEditModal();
                notify.initialEvent();
                this.editButton.disabled = false;
                for(let i = 0; i < this.inputValues.length; i++)this.inputValues[i].value = "";
                this.chosenTags = [];
            ...
            const color = "error";
            const notify = new (0, _popupNotificationJsDefault.default)(this.formError, title, this.mainNode, color);
            notify.initialEvent();
            this.editButton.disabled = false;
        }
        this.formError = [];
    ...
    allReset() {
        for(let i = 0; i < this.allChecks.length; i++)this.allChecks[i].checked = false;
    ...
    deleteQuestion() {
        ...
        for(let i = 0; i < deleteQuestionContainer.length; i++)deleteQuestionContainer[i].addEventListener("click", async (e)=>{
            ...
            this.num.innerHTML = this.setResultNum(this.container.children.length);
...
},{"../AbstractView.js":"jv4Eo","../PopupNotification.js":"fJ8jT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fJ8jT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _abstractViewJs = require("./AbstractView.js");
var _abstractViewJsDefault = parcelHelpers.interopDefault(_abstractViewJs);
...
},{"./AbstractView.js":"jv4Eo","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"e26In":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _abstractViewJs = require("../AbstractView.js");
var _abstractViewJsDefault = parcelHelpers.interopDefault(_abstractViewJs);
          ...
          <div class="chosen-tag ${chosenTag}" name="${chosenTag}">
            ...
            <div class="delete-tag-container">
              <i class="${chosenTag} fas fa-times delete-tag"></i>
                ...
                for(let i1 = 0; i1 < deleteElemens.length; i1++)deleteElemens[i1].addEventListener("click", (e)=>chosenEvent(e));
            }
        };
    }
    _checkForm(inputValues) {
        for(let i = 0; i < inputValues.length; i++)if (!inputValues[i].value) this.formError.push(`${inputValues[i].ariaLabel} is empty.`);
        if (!this.chosenTags.length) this.formError.push(`tag is empty.`);
        if (this.formError.length) return false;
        else return true;
    }
    async createQuestion() {
        ...
        if (formCheck) {
            ...
            await fetch(endpoint, {
                ...
                const notify = new (0, _popupNotificationJsDefault.default)([], "CREAED", this.createSection, "success");
                notify.initialEvent();
                this.createButton.disabled = false;
                for(let i = 0; i < inputValues.length; i++)inputValues[i].value = "";
                this.chosenTags = [];
                this.selectChosen.innerHTML = "";
            }).catch((e)=>console.log(e));
        } else {
            const title = "ERROR OCCURRED";
            const color = "error";
            const notify = new (0, _popupNotificationJsDefault.default)(this.formError, title, this.createSection, color);
            notify.initialEvent();
            this.createButton.disabled = false;
        }
        this.formError = [];
...
},{"../AbstractView.js":"jv4Eo","../PopupNotification.js":"fJ8jT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3NvlB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _abstractViewJs = require("./AbstractView.js");
var _abstractViewJsDefault = parcelHelpers.interopDefault(_abstractViewJs);
...
var _rankingJs = require("./Ranking.js");
var _rankingJsDefault = parcelHelpers.interopDefault(_rankingJs);
exports.default = class extends (0, _abstractViewJsDefault.default) {
    constructor(){
        super();
        this.app = document.querySelector("#app");
    ...
    async beforeInitialRender() {
        this.footer = new (0, _footerJsDefault.default)();
        this.ranking = new (0, _rankingJsDefault.default)();
        this.hideAppNode();
    }
    async initialEvent() {
...
},{"./AbstractView.js":"jv4Eo","./Footer.js":"ca71m","./Ranking.js":"3LE20","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ca71m":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _abstractViewJs = require("./AbstractView.js");
var _abstractViewJsDefault = parcelHelpers.interopDefault(_abstractViewJs);
exports.default = class extends (0, _abstractViewJsDefault.default) {
    constructor(){
        ...
        this.linkedinUrl = "https://www.linkedin.com/in/nobuhiro-funahashi-1b725322b/";
    }
    async renderHTML() {
        return `
      <footer>
...
},{"./AbstractView.js":"jv4Eo","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3LE20":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _authenticationJs = require("../../../../firebase/authentication.js");
var _indexJs = require("../store/index.js");
...
exports.default = class extends (0, _abstractViewJsDefault.default) {
    constructor(){
        super();
        this.scoreData;
        this.userData = (0, _authenticationJs.getUserData)();
        this.userLogin = (0, _authenticationJs.getUserLogin)();
    ...
    async renderHTML() {
        ...
        if (this.userLogin) {
            ...
            const currentScore = (0, _indexJs.getSessionItem)("currentScore");
            const welcome = `
      ...
      `;
        ...
        this.scoreData.forEach((elem, index)=>{
            if (elem.UUID === this.userData.UID) userStyleClass = "rank-name rank-user";
            else userStyleClass = "rank-name";
            let awardFont;
            if (index + 1 === 1) awardFont = `
          <i class="fas fa-crown rank-font">
            <div class="rank-order">${index + 1}
            </div>
          </i>
      `;
            else if (index + 1 === 2) awardFont = `
          <i class="fas fa-award second-award rank-font">
            <div class="rank-order second-third">${index + 1}
            </div>
          </i>
        `;
            else if (index + 1 === 3) awardFont = `
    ...
    async getScoreData() {
        return fetch(this.endpoint).then((result)=>{
            return result.json();
        }).then((data)=>{
            return data;
        });
...
},{"../../../../firebase/authentication.js":"61l5e","../store/index.js":"h1SHO","./AbstractView.js":"jv4Eo","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6u9M3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _authenticationJs = require("../../../../firebase/authentication.js");
var _abstractViewJs = require("./AbstractView.js");
...
exports.default = class extends (0, _abstractViewJsDefault.default) {
    ...
    async loginUser(e) {
        ...
        const formCheck = this._checkForm(inputValues);
        if (formCheck) (0, _authenticationJs.login)(user).then(()=>{
            history.go();
        }).catch((e)=>{
...
},{"../../../../firebase/authentication.js":"61l5e","./AbstractView.js":"jv4Eo","./PopupNotification.js":"fJ8jT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1Mj4w":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "correctNum", ()=>correctNum);
var _abstractViewJs = require("./AbstractView.js");
var _abstractViewJsDefault = parcelHelpers.interopDefault(_abstractViewJs);
var _authenticationJs = require("../../../../firebase/authentication.js");
var _indexJs = require("../store/index.js");
...
exports.default = class extends (0, _abstractViewJsDefault.default) {
    ...
    async fetchData() {
        await fetch(this.endpoint).then((result)=>{
            return result.json();
        }).then((data)=>{
            this.apiData = data;
        });
    ...
    setQuiz() {
        for(let i = 0; i < this.apiData.length; i++)new SetQuiz(this.apiData[i]);
    ...
    quizProgress() {
      ...
      <div class="question-wrapper">
        ...
        for(let i = 0; i <= 3; i++)choices[i].addEventListener("click", (e)=>{
            clearInterval(this.intervalId);
            ...
            if (allQuestion[this.progress].answer == e.target.id) {
                ...
                if (allQuestion.length == this.progress) this.stop();
                else this.intervalId = setTimeout(()=>{
    ...
    countdown() {
        ...
        this.intervalId = setInterval(()=>{
            let singularOrPlural = startSecond === 2 ? "second" : "seconds";
            let greaterThanThree = startSecond > 4 ? "base-count-num" : "last-three";
            if (startSecond > 0) {
                startSecond -= 1;
            ...
            `;
              ...
              `;
                ...
                document.querySelector(".social-img").addEventListener("click", ()=>{
                    const shareURL = "https://twitter.com/intent/tweet?text=%23RankingQuizDojo%20%0aYour score is " + this.correctNum + "%0a" + "&url=" + `${frontURL}`;
    ...
    async updateScore() {
        ...
        const scoreEndpoint = url + scorePath;
        const maxScore = (0, _indexJs.getSessionItem)("currentScore");
        if (maxScore && maxScore < this.correctNum) await fetch(scoreEndpoint, {
            method: "PATCH",
            body: JSON.stringify({
            ...
            (0, _indexJs.setSessionStorage)("currentScore", this.correctNum);
        });
    }
    shaffleArray(array) {
...
},{"./AbstractView.js":"jv4Eo","../../../../firebase/authentication.js":"61l5e","../store/index.js":"h1SHO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3yuwC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _authenticationJs = require("../../../../firebase/authentication.js");
var _indexJs = require("../store/index.js");
...
exports.default = class extends (0, _abstractViewJsDefault.default) {
    ...
    async signupUser(e) {
        ...
        if (formCheck) (0, _authenticationJs.createUser)(user).then((e)=>{
            const userData = (0, _authenticationJs.getUserData)();
            ...
            (0, _indexJs.setSessionStorage)("currentScore", this.score);
            window.removeEventListener("beforeunload", this.callback, true);
        }).then(()=>history.go()).catch((e)=>{
            this.formError.push(e.errorCode);
            this.errorHandler();
        });
        else {
...
},{"../../../../firebase/authentication.js":"61l5e","../store/index.js":"h1SHO","./AbstractView.js":"jv4Eo","./PopupNotification.js":"fJ8jT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jlceo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _abstractViewJs = require("./AbstractView.js");
var _abstractViewJsDefault = parcelHelpers.interopDefault(_abstractViewJs);
    ...
    result(results) {
        ...
        if (results.length) {
            ...
            results.forEach((result)=>{
                this.currentDom.push(result);
                this.container.innerHTML += '<div aria-live="polite" class="each-item"></div>';
                let each = document.querySelectorAll(".each-item");
                this.keysArray.forEach((e)=>{
                    if (e !== "tags") each[each.length - 1].innerHTML += `
              <div class="category">
...
},{"./AbstractView.js":"jv4Eo","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["3dAzu","5nPzB"], "5nPzB", "parcelRequire4d14")

//# sourceMappingURL=index.700e922e.js.map
